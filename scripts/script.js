...
if (person) {
  ...
  document.getElementById("person-bio").innerHTML = person.bio;
  ...
  document.querySelector(".person-profile").innerHTML = "<h1>Person not found</h1>";
}