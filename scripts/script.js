...
chuanhui: {
    ...
    title: "Producer",
    bio: [
      "As a producer, I helped coordinate communication between the art and programming teams while supporting production planning, task tracking, and playtesting. I also assisted with scene implementation in Unity and helped adapt development plans when technical issues, bugs, or missing assets affected the build.",
      "As an artist, I develop the project’s art style and created pipeline documentation for both 2D and 3D asset production. My work included creating modular furniture models, handling much of the project’s texturing, building reusable smart materials in Substance Painter for common materials such as wood, and creating a base material with outline and overlay layers for stylistic consistency. I also created 2D textures and illustrations for environmental assets and decorative elements, while exploring techniques for generating normal maps for 2D assets.",
      "On the technical art side, I worked on shaders, visual effects, lighting, and light baking in Unity to support the game’s overall presentation and atmosphere."
    ],
    links: [
